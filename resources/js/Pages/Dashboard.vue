...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2
                class="text-3xl font-bold leading-tight text-red-500"
            >
                Cheesy Does It Pizza Restaurant
            </h2>
        </template>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div
                    class="overflow-hidden bg-yellow-200 shadow-sm sm:rounded-lg"
                >
                    <div class="p-6 text-red-500 text-5xl text-center font-bold">
                        Where good pizza is made.
                    </div>
